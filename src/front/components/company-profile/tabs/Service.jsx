    ...
    <div className="container mt-4">
      ...
      <div className="row">
        {listaServicios.map((srv) => {
          const ciudad = ciudades.find(c => Number(c.id) === Number(srv.city_id));
          console.log("Servicio ID Ciudad:", srv.city_id, "Lista ciudades:", ciudades);
          return (
            <div key={srv.id} className="col-md-6 mb-4">
              <div className="card h-100 shadow-sm border-0">
                <div className="card-body">
                  ...
                  <p className="mb-1 small">📍 {srv.direction}{ciudad ? `, ${ciudad.name}` : ""}</p>
        ...
        <div className="modal d-block modals">
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content border-0">
              <div className={`modal-header ${modalAbierto === 'crear' ? 'bg-success' : 'bg-warning'}`}>
                <h5 className="modal-title modal-text">{modalAbierto === 'crear' ? 'Nuevo Servicio' : 'Editar Servicio'}</h5>
